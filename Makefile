...
bin/fith: src/fith_compiler.c src/fith_data.c tool_output/fith_lex.c sqlite3/sqlite3.o SQLite3_Helper/bin/sqlite3Helper
	./SQLite3_Helper/bin/sqlite3Helper
	gcc -O2 -s -o bin/fith src/fith_compiler.c sqlite3/sqlite3.o -Wall -ldl
	size bin/fith
